...
Admin pages are at:
http://bamru-public.r210x.com/admin

(userid/passwd = admin/admin)
...
events on the website.  The admin page is password
protected.  Reset the password using the '/admin_password'
page.
